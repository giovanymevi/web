...
const Hero = () => {
  return (
    <section id="inicio" className="pt-32 pb-20 bg-gradient-to-br from-[#020617] via-[#0c1225] to-primary/20 relative overflow-hidden">
      <ParticleCanvas />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto lg:mx-0">
              Software moderno y futurista para impulsar tu crecimiento digital
            </p>
